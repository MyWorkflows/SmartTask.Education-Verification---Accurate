...
<template>
  <form>
    <div class="flex-column mb-4">
      <div>
      <img style="max-width:200px" src="https://4bgowik9viu406fbr2hsu10z-wpengine.netdna-ssl.com/wp-content/uploads/2020/02/logo.svg"/>
       </div>
       <p class="mt-2">
         Education verification provided by Accurate
          </p>
    </div>
    <div class="row mb-4">
      <div class="col">
